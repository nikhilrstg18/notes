...
```
If an exception occurs in an [iterator method](https://learn.microsoft.com/en-us/dotnet/csharp/iterators), it propagates to the caller only when the iterator advances to the next element.
